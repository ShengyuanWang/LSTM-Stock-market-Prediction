...
if __name__ == '__main__':
    ...
    df11 = pd.read_csv('./code/prediction/bitcoin_ARIMA_result.csv')
    df22 = pd.read_csv('./code/prediction/gold_ARIMA_result.csv')
    ...
    #     transFeeRateMod1 = transFeeRate1 * i /100
    #     actionVecMod1 = find_optimal_action(pricePre1, transFeeRateMod1)
    #     returnRateMod1 = profit_estimate(priceVec1, transFeeRateMod1, actionVecMod1)
    #     returnRateModa.append(returnRateMod1)
    #     transFeeRatea.append(transFeeRateMod1)
    #     transFeeRateMod2 = transFeeRate2 * i / 100
    #     actionVecMod2 = find_optimal_action(pricePre2, transFeeRateMod2)
    #     returnRateMod2 = profit_estimate(priceVec2, transFeeRateMod2, actionVecMod2)
    #     returnRateModb.append(returnRateMod2)
    #     transFeeRateb.append(transFeeRateMod2)
    # for i in range(len(returnRateModa)):
    #     plt.plot(transFeeRatea[i], returnRateModa[i], 'o', ms=5, color='red')
    # plt.show()
    # for i in range(len(returnRateModb)):
    #     plt.plot(transFeeRateb[i], returnRateModb[i], 'o', ms=5, color='red')
    # plt.show()
